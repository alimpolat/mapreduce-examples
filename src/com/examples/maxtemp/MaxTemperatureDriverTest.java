...
// MaxTemperatureDriverTest: A test for MaxTemperatureDriver that uses a local, in-process job runner
...
public class MaxTemperatureDriverTest {
	...
	private void checkOutput(Configuration conf, Path output) throws IOException {
		...
		BufferedReader expected = asBufferedReader(fs.open(new Path("expected/sample-expected.txt")));
		String expectedLine;
