...
import patterns.joins.reduceside.CommentJoinMapper;
import patterns.joins.reduceside.UserJoinMapper;
import patterns.joins.reduceside.UserJoinReducer;

public class ReplicatedUserJoinDriver extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		Job job = Job.getInstance(getConf(), "StackOverflow MapSideJoin User & Comments");
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new ReplicatedUserJoinDriver(), args);
		System.exit(res);
	}
}
